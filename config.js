...
global.nomorown = '628217143235i'
global.namebot = 'MGBOTZ'
global.nameown = 'JANGAN SEPI YA :V'
...
/*============== STAFF ==============*/
global.owner = [
  ['6282171432358', 'WH MODS DEV', true],
  ['-', 'isi_kalau_ada', true],
  ['-', 'isi_kalau_ada', true],
...
/*============== WATERMARK ==============*/
global.wm = '「 MGBOTZ-MULTIDEVICE 」' //Main Watermark
global.wm2 = 'MGBOTZ-MD'
global.wm3 = '⫹⫺ MGBOTZ MULTIDEVICE '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By MGBOTZ`
global.author = '「 MGBOTZ-MD 」'
